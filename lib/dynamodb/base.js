...
Base.prototype = {
  ...
  queryDDB: function(methodName, params) {
    const oThis = this;
    oThis.serviceType = dynamoFactory.raw;
    const dbInstance = dynamoFactory.getProvider(oThis.clientID, oThis.serviceType);

    oThis.call(dbInstance, oThis.methodName, params);
  },

  queryDocClient: function(methodName, params) {
    const oThis = this;
    oThis.serviceType = dynamoFactory.documentClient;
    const dbInstance = dynamoFactory.getProvider(oThis.clientID, oThis.serviceType);
