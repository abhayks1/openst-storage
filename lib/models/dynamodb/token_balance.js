...
const tokenBalanceModelSpecificPrototype = {
  ...
  update: async function(params) {
    ...
    const balanceParams = {
      ...
      ExpressionAttributeValues: {
        ":deltaSB": deltaSB,
        ":deltaUD": deltaUD,
        ":delta_pessimistic_balance": deltaPessimisticBalance
      },
      ReturnValues: "NONE"
    };
    ...
    if((new BigNumber(deltaUD)).gt(new BigNumber(0))){
      ...
      balanceParams['ExpressionAttributeValues'][':deltaUD'] = deltaUD;
  ...
  _keyObj: function (params) {
    ...
    keyObj[oThis.shortNameFor('ethereum_address')] = params['ethereum_address'];
    keyObj[oThis.shortNameFor('erc20_contract_address')] = oThis.erc20ContractAddress;
